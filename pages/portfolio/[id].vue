  ...
  <v-container class="py-6">
    <v-row>
      <v-col cols="12" md="8">
        ...
        <h2 class="section-heading">Юзерфлоу или CJM</h2>
        <ol class="custom-list">
          <li v-for="(step, i) in project?.flow || []" :key="i">{{ step }}</li>
        </ol>

        <h2 class="section-heading">Функционал</h2>
      ...
      <v-col cols="12" md="4">
        <h3 class="section-subheading">Топики</h3>
        <v-chip
        ...
        <h3 class="section-subheading">Технологии</h3>
        <v-chip
        ...
        >
          <v-carousel-item v-for="(img, index) in project.images" :key="index">
            <v-img :src="img" cover class="carousel-img" />
          </v-carousel-item>
        </v-carousel>
      </v-col>
    </v-row>
