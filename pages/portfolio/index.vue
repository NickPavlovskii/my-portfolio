<template>
    <v-container class="projects-page min-h-screen bg-gray-100 py-6">
      <name-display :name="name" letterColor="#08b200" />
      ...
      <v-row v-if="filteredProjects.length === 0" justify="center" class="mt-6">
        <v-col cols="12" class="text-center">
  ...
  import { PROJECTS, FRAMEWORKS, PROJECT_TYPES } from '~/components/portfolio/projects';
